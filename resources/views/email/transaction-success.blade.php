                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#2B2B28;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div class="text-accentBlack"
                                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:">
                                                                    Hi, <span
                                                                        class="text-accentOrange">{{ $data->user->name }}</span>
                                                                    <br><br> Tiket digital
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    border="0"
                                                                    style="color:#2B2B28;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                                    <tr>
                                                                        <td colspan="3">Members</td>
                                                                    </tr>
                                                                    @foreach ($data->details as $item)
                                                                        <tr>
                                                                            <td><strong>{{ $data->user->name }}</strong>
                                                                            </td>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" bgcolor="#FF9E53"
                                                                            ...
                                                                            valign="middle">
                                                                            <a href="#"
                                                                                style="display:inline-block;background:#3BBABE;color:#ffffff;font-family:Assistant, Helvetica, sans-serif;font-size:18px;font-weight:500;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:5px;">
                                                                                Check Details </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#2B2B28;">
                                                    Butuh Bantuan?</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width:50px">
                                                            <img src="{{ url('./images/call.svg') }}" width="50px" />
                                                        </td>
                                                        <td
                                                            style="font-size: 18px; padding-left:10px; color: #2B2B28; font-family: Assistant, Helvetica, Arial, sans-serif;" />
                                                        support@howiday.id <br> 0812 - 9911 - 5053
                                            </td>
                                        </tr>
                                </table>
                        </td>
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                2021 Howiday Copyright&#169; All right Reserved.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
