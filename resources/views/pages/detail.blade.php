...
@section('content')
    ...
    <section class="travel-details container mx-auto px-5 lg:px-0 mb-12">
        <div class="flex flex-col lg:flex-row items-start">
            <div class="left w-full lg:w-2/3 lg:mb-0 mb-7 border border-gray-300 rounded-2xl mr-7 p-7">
                <div class="flex flex-col lg:flex-row mb-12">
                    ...
                    <div class="w-full lg:w-1/2">
                        <h1 class="font-playfair font-bold text-accentBlack text-4xl mb-2 text-center lg:text-left">
                            {{ $item->title }}
                        </h1>
                ...
                <div class="gallery mb-12">
                    <h1 class="font-poppins text-center font-medium text-2xl tracking-widest mb-7">Gallery</h1>
                ...
                <div class="service">
                    <h1 class="font-poppins text-center font-medium text-2xl tracking-widest mb-7">Service</h1>
                    <div class="flex flex-row items-center justify-center">
                        <div class="flex flex-col md:flex-row items-center lg:mr-8 mr-5">
                            ...
                            <div class="flex flex-col">
                                <h1
                                    class="font-poppins font-semibold text-accentDarkGray  text-sm md:text-base text-center md:text-left">
                                    Featured Event
                                </h1>
                                <h4
            ...
            <div class="right w-full lg:w-1/3 border border-gray-300 rounded-t-2xl rounded-b-2xl lg:rounded-b-none">
                <div class="pt-12 pb-9 px-8">
                    <h1 class="mb-4 text-accentBlack font-poppins font-medium text-2xl">Members are Going</h1>
                    ...
                    <hr class="mb-6" />
                    <h1 class="mb-4 text-accentBlack font-poppins font-medium text-2xl">Trip Details</h1>
                    <div class="flex flex-row justify-between mb-1">
                        <h2 class="text-gray-500 font-poppins font-semibold text-lg text-left">Departure</h2>
                        <h3 class="font-normal font-poppins text-lg text-gray-400 text-right">
                            {{ \Carbon\Carbon::create($item->departure_date)->format('F n, Y') }}
                        </h3>
                    </div>
                    <div class="flex flex-row justify-between mb-1">
                        <h2 class="text-gray-500 font-poppins font-semibold text-lg text-left">Duration</h2>
                        <h3 class="font-normal font-poppins text-lg text-gray-400 text-right">
                            {{ $item->duration }}
                        </h3>
                    </div>
                    <div class="flex flex-row justify-between mb-1">
                        <h2 class="text-gray-500 font-poppins font-semibold text-lg text-left">Type</h2>
                        <h3 class="font-normal font-poppins text-lg text-gray-400 text-right">
                            {{ $item->type }}
                        </h3>
                    </div>
                    <div class="flex flex-row justify-between mb-1">
                        <h2 class="text-gray-500 font-poppins font-semibold text-lg text-left">Price </h2>
                        <h3 class="font-normal font-poppins text-lg text-gray-400 text-right">
                    ...
                    @auth
                        <form action="{{ route('checkout-process', $item->id) }}" method="POST">
                            ...
                            <button href="#" type="submit"
                                class="inline-block w-full bg-accentCyan hover:bg-accentCyanHover font-poppins font-medium text-lg text-white  py-4 transition duration-300 rounded-b-2xl lg:rounded-b-none focus:outline-none">Join
                                Now</button>
                        </form>
                    @endauth
                    @guest
