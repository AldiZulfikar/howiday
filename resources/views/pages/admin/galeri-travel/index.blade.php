                    ...
                    <div class="card-header border-transparent">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool">
                                <a href="{{ route('galeri-travel.create') }}"><i class="fas fa-plus"></i></a>
                            </button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <table class="table m-0" border="1">
                                ...
                                <tbody>
                                    @forelse($items as $row)
                                        <tr>
                                            <td>
                                                <a href="pages/examples/invoice.html">{{ $row->id }}
                                                </a>
                                            </td>
                                            <td>{{ $row->travel_package->title }}</td>
                                            <td><img src="{{ Storage::url($row->image) }}" alt="" style="width: 150px;"
                                                    class="img-thumbnail" /></td>
                                            <td>
                                                <div class="sparkbar" data-color="#00a65a" data-height="20">
                                                    <a class="badge badge-success"
                                                        href="{{ route('galeri-travel.edit', $row->id) }}">Edit</a> |
